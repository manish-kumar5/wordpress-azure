...
// Shortcode template
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCode' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeSingle' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeSingle extends MICRO_OFFICE_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeAlone' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeAlone extends MICRO_OFFICE_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeContainer' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeContainer extends MICRO_OFFICE_VC_ShortCode {
...
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeCollection' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeCollection extends MICRO_OFFICE_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeItem' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeItem extends MICRO_OFFICE_VC_ShortCode {
...
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeColumns' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeColumns extends MICRO_OFFICE_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('MICRO_OFFICE_VC_ShortCodeAccordion') ) {
	abstract class MICRO_OFFICE_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class MICRO_OFFICE_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('MICRO_OFFICE_VC_ShortCodeToggles') ) {
	abstract class MICRO_OFFICE_VC_ShortCodeToggles extends MICRO_OFFICE_VC_ShortCodeAccordion {}
	abstract class MICRO_OFFICE_VC_ShortCodeTogglesItem extends MICRO_OFFICE_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'MICRO_OFFICE_VC_ShortCodeTabs' ) ) {
	abstract class MICRO_OFFICE_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class MICRO_OFFICE_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
