<div class="to_demo_wrap">
	<a href="" class="to_demo_pin iconadmin-pin" title="<?php esc_attr_e('Pin/Unpin demo-block by the right side of the window', 'micro-office'); ?>"></a>
	<div class="to_demo_body_wrap">
		<div class="to_demo_body">
			...
			<?php 
			$colors = micro_office_storage_get('custom_colors');
