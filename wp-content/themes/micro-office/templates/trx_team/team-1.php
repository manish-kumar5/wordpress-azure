...
if ( !function_exists( 'micro_office_template_team_1_theme_setup' ) ) {
	add_action( 'micro_office_action_before_init_theme', 'micro_office_template_team_1_theme_setup', 1 );
	function micro_office_template_team_1_theme_setup() {
		micro_office_add_template(array(
			'layout' => 'team-1',
			'template' => 'team-1',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 1/', 'micro-office'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'micro-office'),
			'w' => 370,
			'h' => 370
		));
	}
...
// Template output
if ( !function_exists( 'micro_office_template_team_1_output' ) ) {
	function micro_office_template_team_1_output($post_options, $post_data) {
		$show_title = true;
