...
if ( !function_exists( 'micro_office_template_related_theme_setup' ) ) {
	add_action( 'micro_office_action_before_init_theme', 'micro_office_template_related_theme_setup', 1 );
	function micro_office_template_related_theme_setup() {
		micro_office_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'micro-office'),
			'thumb_title'  => esc_html__('Medium image (crop) - related', 'micro-office'),
			'w'		 => 555,
			'h'		 => 375
		));
		micro_office_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'micro-office'),
			'thumb_title'  => esc_html__('Medium image (crop) - related', 'micro-office'),
			'w'		 => 555,
			'h'		 => 375
		));
		micro_office_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'micro-office'),
			'thumb_title'  => esc_html__('Medium image (crop) - related', 'micro-office'),
			'w'		 => 555,
			'h'		 => 375
		));
		micro_office_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'micro-office'),
			'thumb_title'  => esc_html__('Medium image (crop) - related', 'micro-office'),
			'w'		 => 555,
			'h'		 => 375
		));
...
// Template output
if ( !function_exists( 'micro_office_template_related_output' ) ) {
