...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Micro Office
	 * @var $inverse	- added by Micro Office
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Micro Office:
	// Color scheme
	if ($scheme && !micro_office_param_is_off($scheme) && !micro_office_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !micro_office_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Micro Office color scheme in the row
	if ($scheme && !micro_office_param_is_off($scheme) && !micro_office_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php micro_office_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php micro_office_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
