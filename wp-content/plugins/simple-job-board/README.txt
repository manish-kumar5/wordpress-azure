...
Yes, you can upload a resume document with different extensions from the settings page.

= How can I make sure that the Resume document file is not accessible by general public? = 
You can use the anti-hotlinking option in the settings to enhance the security of your document.

= How can I add a custom template for job post page? =
...
== Upgrade Notice ==
= 2.4.5 =
2.4.5 is a minor release with the fix of resume downloading issue.